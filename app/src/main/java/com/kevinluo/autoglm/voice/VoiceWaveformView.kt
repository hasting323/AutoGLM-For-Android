...
class VoiceWaveformView @JvmOverloads constructor(
    ...
    private val weights = floatArrayOf(
        0.10f, 0.14f, 0.18f, 0.22f, 0.26f, 0.30f, 0.35f, 0.40f, 0.45f, 0.50f,
        0.56f, 0.62f, 0.68f, 0.76f, 0.85f,
        1.0f,
        0.85f, 0.76f, 0.68f, 0.62f, 0.56f,
        0.50f, 0.45f, 0.40f, 0.35f, 0.30f, 0.26f, 0.22f, 0.18f, 0.14f, 0.10f
    )
